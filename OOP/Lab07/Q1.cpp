...
int main()
{
    SavingsAccount savings("SA123", "louis", 1000.0, 5.0);
    CheckingAccount checking("CA123", "Biden", 500.0, 100.0);
    FixedDepositAccount fixedDeposit("FDA123", "Nicholas", 2000.0, 6.0, "2026-12-31");
